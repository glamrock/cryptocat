			...
			<script type="text/javascript">
				...
				function translate() {
					if (curlang == "english") {
						...
						document.getElementById("bottom").innerHTML = \'<a href="#" id="translate" onclick="translate()">english</a> | <a href="about">sobre</a> | cryptocat és el programari beta en el desenvolupament actiu | <a target="_blank" href="http://twitter.com/cryptocatapp">twitter</a>\';
